  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file://C:/Users/AVidal/Documents/Projects/SEPA/frontier/docs/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _WmST2w = defineEventHandler(async (event) => {
...
const _R34dIw = defineEventHandler(async (event) => {
...
const _f2nWGE = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _lazy_RJItTH = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_RJItTH, lazy: true, middleware: false, method: undefined },
  { route: '/api/_github/repository', handler: _ARm6OY, lazy: false, middleware: false, method: undefined },
  { route: '/api/_github/repository/:query', handler: _ARm6OY, lazy: false, middleware: false, method: undefined },
  { route: '/api/_github/readme', handler: _iRPLgs, lazy: false, middleware: false, method: undefined },
  { route: '/api/_github/readme/:query', handler: _iRPLgs, lazy: false, middleware: false, method: undefined },
  { route: '/api/_github/releases', handler: _NEJdt7, lazy: false, middleware: false, method: undefined },
  { route: '/api/_github/releases/:query', handler: _NEJdt7, lazy: false, middleware: false, method: undefined },
  { route: '/api/_github/contributors', handler: _MDsoYx, lazy: false, middleware: false, method: undefined },
  { route: '/api/_github/contributors/:query', handler: _MDsoYx, lazy: false, middleware: false, method: undefined },
  { route: '/api/_github/contributors/file', handler: _ggs6yT, lazy: false, middleware: false, method: undefined },
  { route: '/api/_github/contributors/file/:query', handler: _ggs6yT, lazy: false, middleware: false, method: undefined },
  { route: '/api/_github/commits', handler: _F3w3u7, lazy: false, middleware: false, method: undefined },
  { route: '/api/_github/commits/:query', handler: _F3w3u7, lazy: false, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _WmST2w, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _WmST2w, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _WmST2w, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _R34dIw, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _f2nWGE, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _f2nWGE, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _f2nWGE, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_RJItTH, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://C:/Users/AVidal/Documents/Projects/SEPA/frontier/docs/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://C:/Users/AVidal/Documents/Projects/SEPA/frontier/docs/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<script defer=\"\" data-domain=\"frontier.realdecoy.com\" src=\"https://plausible.io/js/script.js\"></script>","bodyTags":"","bodyTagsOpen":"","htmlAttrs":"","bodyAttrs":""};
