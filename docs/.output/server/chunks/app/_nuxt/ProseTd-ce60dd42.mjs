...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<td${ssrRenderAttrs(_attrs)} data-v-281e7d4a>`);
...
const __nuxt_component_5 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-281e7d4a"]]);

export { __nuxt_component_5 as default };
//# sourceMappingURL=ProseTd-ce60dd42.mjs.map
