...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h5${ssrRenderAttrs(mergeProps({ id: __props.id }, _attrs))} data-v-35e434df>`);
...
const ProseH5 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-35e434df"]]);

export { ProseH5 as default };
//# sourceMappingURL=ProseH5-0c6e8cd8.mjs.map
