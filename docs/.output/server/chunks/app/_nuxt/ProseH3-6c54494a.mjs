...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h3${ssrRenderAttrs(mergeProps({ id: __props.id }, _attrs))} data-v-c013d38e>`);
...
const ProseH3 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c013d38e"]]);

export { ProseH3 as default };
//# sourceMappingURL=ProseH3-6c54494a.mjs.map
