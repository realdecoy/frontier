...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h2${ssrRenderAttrs(mergeProps({ id: __props.id }, _attrs))} data-v-273f00cc>`);
...
const ProseH2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-273f00cc"]]);

export { ProseH2 as default };
//# sourceMappingURL=ProseH2-abc0d7da.mjs.map
