...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h1${ssrRenderAttrs(mergeProps({ id: __props.id }, _attrs))} data-v-d187dd3d>`);
...
const ProseH1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d187dd3d"]]);

export { ProseH1 as default };
//# sourceMappingURL=ProseH1-81b8c44a.mjs.map
