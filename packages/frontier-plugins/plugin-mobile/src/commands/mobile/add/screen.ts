...
import { checkProjectValidity, parseScreenName } from '../../../lib/utilities';
    ...
    if (isValidProject === false) {
      throw new Error(
        JSON.stringify({
          ...
          message: `${CLI_COMMANDS.AddScreen} command must be run in an existing ${chalk.yellow('mobile')} project`,
        }),
      );
    }
